...
1. Check if the bug has already been reported in [Issues](https://github.com/Opentab1/hmmm/issues)
...
1. **Fork the repository**
   ```bash
   git clone https://github.com/Opentab1/hmmm.git
   cd pulse
   ```
...
- Check the [Wiki](https://github.com/Opentab1/hmmm/wiki)
- Ask in [Discussions](https://github.com/Opentab1/hmmm/discussions)
